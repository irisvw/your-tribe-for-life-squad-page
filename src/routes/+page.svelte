...
<p class="animation-fade-in" style="--delay: 0.25s">
    Op deze pagina zie je precies wanneer iedereen jarig is. Zo mis je nooit de
    leukste events van het jaar: verjaardagen! Een felicitatie, een stukje taart
    of gewoon een extra gezellige dag. Het kan allemaal. Wil je meer weten over
    de jarige? Klik dan door naar hun persoonlijke pagina.
</p>
